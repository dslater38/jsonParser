...
/* Line 371 of yacc.c  */
#line 87 "D:\\Dev\\json\\msvc\\json\\..\\..\\json.tab.cc"
...
/* Line 387 of yacc.c  */
#line 126 "D:\\Dev\\json\\msvc\\json\\..\\..\\json.tab.cc"
...
/* Line 387 of yacc.c  */
#line 176 "D:\\Dev\\json\\msvc\\json\\..\\..\\json.tab.cc"
} YYSTYPE;
...
/* Line 390 of yacc.c  */
#line 204 "D:\\Dev\\json\\msvc\\json\\..\\..\\json.tab.cc"
...
static const yytype_uint8 yyrline[] =
{
      ...
      85,    86,    90,    95,   102,   103,   107,   113,   114,   118
};
#endif
...
/* Line 1792 of yacc.c  */
#line 71 "json.y"
    { parsd = std::move((yyvsp[(1) - (1)].value_p)); }
    break;

  case 3:
/* Line 1792 of yacc.c  */
#line 74 "json.y"
    { new (&(yyval.object_p)) JSON::Object{std::move((yyvsp[(2) - (3)].object_p))}; }
    break;

  case 4:
/* Line 1792 of yacc.c  */
#line 77 "json.y"
    { new (&(yyval.array_p)) JSON::Array{std::move((yyvsp[(2) - (3)].array_p))}; }
    break;

  case 5:
/* Line 1792 of yacc.c  */
#line 80 "json.y"
    { new (&(yyval.value_p)) JSON::Value{(yyvsp[(1) - (1)].int_v)}; }
    break;

  case 6:
/* Line 1792 of yacc.c  */
#line 81 "json.y"
    { new (&(yyval.value_p)) JSON::Value{(yyvsp[(1) - (1)].float_v)}; }
    break;

  case 7:
/* Line 1792 of yacc.c  */
#line 82 "json.y"
    { new (&(yyval.value_p)) JSON::Value{(yyvsp[(1) - (1)].bool_v)}; }
    break;

  case 8:
/* Line 1792 of yacc.c  */
#line 83 "json.y"
    { new (&(yyval.value_p)) JSON::Value{}; }
    break;

  case 9:
/* Line 1792 of yacc.c  */
#line 84 "json.y"
    { new (&(yyval.value_p)) JSON::Value{std::move((yyvsp[(1) - (1)].string_v))}; }
    break;

  case 10:
/* Line 1792 of yacc.c  */
#line 85 "json.y"
    { new (&(yyval.value_p)) JSON::Value{std::move((yyvsp[(1) - (1)].object_p))}; }
    break;

  case 11:
/* Line 1792 of yacc.c  */
#line 86 "json.y"
    { new (&(yyval.value_p)) JSON::Value{std::move((yyvsp[(1) - (1)].array_p))}; }
    break;
...
#line 90 "json.y"
    {
        ...
        new(&(yyval.string_v)) std::string{s.substr(1, s.length()-2)};
    }
    break;
...
/* Line 1792 of yacc.c  */
#line 102 "json.y"
    { new(&(yyval.object_p)) JSON::Object{}; }
    break;
...
#line 103 "json.y"
    {
		new(&(yyval.object_p)) JSON::Object{};
        (yyval.object_p).emplace((yyvsp[(1) - (3)].string_v).c_str(), std::move((yyvsp[(3) - (3)].value_p)));
    }
    break;
...
#line 107 "json.y"
    { 
        (yyval.object_p).emplace((yyvsp[(3) - (5)].string_v).c_str(), std::move((yyvsp[(5) - (5)].value_p)));
    }
    break;
...
#line 114 "json.y"
    {
        new (&(yyval.array_p)) JSON::Array{};
        (yyval.array_p).emplace_back(std::move((yyvsp[(1) - (1)].value_p)));
    }
    break;
...
#line 118 "json.y"
    { 
        (yyval.array_p).emplace_back(std::move((yyvsp[(3) - (3)].value_p))); 
    }
    break;


/* Line 1792 of yacc.c  */
#line 1528 "D:\\Dev\\json\\msvc\\json\\..\\..\\json.tab.cc"
      default: break;
    }
